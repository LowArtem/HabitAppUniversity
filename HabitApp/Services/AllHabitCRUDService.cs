...
{
    public class AllHabitCRUDService
    {
        private readonly HabitRepository _habitRepository;
        private readonly DailyHabitRepository _dailyHabitRepository;
        private readonly TaskRepository _taskRepository;

        public AllHabitCRUDService(HabitRepository habitRepository, DailyHabitRepository dailyHabitRepository, TaskRepository taskRepository)
        {
